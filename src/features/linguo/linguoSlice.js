...
import { compose, uniq } from '~/shared/fp';
...
export const selectAllAddresses = state => {
  ...
  return compose(uniq, Object.values)(byLanguageGroupPair);
};

export const selectLinguoAddress = ({ sourceLanguage, targetLanguage }) => state => {
